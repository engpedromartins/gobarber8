import { startOfDay, endOfDay, setHours, isAfter, setMinutes, setSeconds, format } from 'date-fns'
...
class AvailableController {
  async index(req, res) {
    ...
    const available = schedule.map(time => {
      ...
      const value = setSeconds(setMinutes(setHours(seachDate, hour), minute), 0)
      return {
        time,
